...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//$('#fr2').submit(false); - 버튼 안 넘어가게 하는 기능
		
		$('#fr2').submit(function(){
			//alert("제이쿼리 사용해서 폼태그 제어");
			var data = $('#data2').val();
			alert(data);
...
<body>
	...
	<form action="a.jsp" method="get" id="fr" onsubmit="return check()" name="fr">
